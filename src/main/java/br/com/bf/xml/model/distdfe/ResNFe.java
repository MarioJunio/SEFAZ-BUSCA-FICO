...
// Gerado em: 2017.04.28 às 03:45:56 PM BRT 
//
...
public class ResNFe {
	...
	public String toString() {
		return "ResNFe [chNFe=" + chNFe + ", cnpj=" + cnpj + ", cpf=" + cpf + ", xNome=" + xNome + ", ie=" + ie + ", dhEmi=" + dhEmi + ", tpNF=" + tpNF + ", vnf=" + vnf
				+ ", digVal=" + Arrays.toString(digVal) + ", dhRecbto=" + dhRecbto + ", nProt=" + nProt + ", cSitNFe=" + cSitNFe + ", versao=" + versao + "]";
	}
