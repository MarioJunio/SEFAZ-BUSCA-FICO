...
// Gerado em: 2017.04.28 às 03:15:10 PM BRT 
//
...
public class TProtNFe {
	...
	public String toString() {
		return "TProtNFe [infProt=" + infProt + ", signature=" + signature + ", versao=" + versao + "]";
	}
    ...
    public static class InfProt {
        ...
        @Override
		public String toString() {
			return "InfProt [tpAmb=" + tpAmb + ", verAplic=" + verAplic + ", chNFe=" + chNFe + ", dhRecbto=" + dhRecbto + ", nProt=" + nProt + ", digVal="
					+ Arrays.toString(digVal) + ", cStat=" + cStat + ", xMotivo=" + xMotivo + ", id=" + id + "]";
		}
