...
public class TretEvento {
	...
	public String toString() {
		return "TretEvento [infEvento=" + infEvento + ", signature=" + signature + ", versao=" + versao + "]";
	}
	 ...
	 * 
	 * @return possible object is {@link TretEvento.InfEvento }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link TretEvento.InfEvento }
	 * 
	 */
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "InfEvento", propOrder = { "tpAmb", "verAplic", "cOrgao", "cStat", "xMotivo", "chNFe", "tpEvento", "xEvento", "nSeqEvento", "cnpjDest", "cpfDest",
			"emailDest", "dhRegEvento", "nProt" })
	@XmlRootElement(name = "infEvento")
	public static class InfEvento {

		@Override
		public String toString() {
			return "InfEvento [tpAmb=" + tpAmb + ", verAplic=" + verAplic + ", cOrgao=" + cOrgao + ", cStat=" + cStat + ", xMotivo=" + xMotivo + ", chNFe=" + chNFe
					+ ", tpEvento=" + tpEvento + ", xEvento=" + xEvento + ", nSeqEvento=" + nSeqEvento + ", cnpjDest=" + cnpjDest + ", cpfDest=" + cpfDest
					+ ", emailDest=" + emailDest + ", dhRegEvento=" + dhRegEvento + ", nProt=" + nProt + ", id=" + id + "]";
		}
