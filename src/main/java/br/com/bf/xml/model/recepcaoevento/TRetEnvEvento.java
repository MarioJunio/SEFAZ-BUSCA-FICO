...
@XmlType(name = "TRetEnvEvento", namespace = "http://www.portalfiscal.inf.br/nfe", propOrder = { "idLote", "tpAmb", "verAplic", "cOrgao", "cStat", "xMotivo",
		"retEvento" })
...
public class TRetEnvEvento {
	...
	public String toString() {
		return "TRetEnvEvento [idLote=" + idLote + ", tpAmb=" + tpAmb + ", verAplic=" + verAplic + ", cOrgao=" + cOrgao + ", cStat=" + cStat + ", xMotivo=" + xMotivo
				+ ", retEvento=" + retEvento + ", versao=" + versao + "]";
	}
	...
	@XmlElement(name = "retEvento", required = true)
	 ...
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the retEvento property.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link TretEvento }
	 * 
	 * 
	 */
